...
{
    default DeviceInfo checkState(int deviceId)
    {
        return checkState(deviceId, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default DeviceInfo checkState(int deviceId, java.util.Map<String, String> context)
    {
        return _iceI_checkStateAsync(deviceId, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<DeviceInfo> checkStateAsync(int deviceId)
    {
        return _iceI_checkStateAsync(deviceId, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<DeviceInfo> checkStateAsync(int deviceId, java.util.Map<String, String> context)
    {
        return _iceI_checkStateAsync(deviceId, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<DeviceInfo> _iceI_checkStateAsync(int iceP_deviceId, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<DeviceInfo> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "checkState", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
